...
cx=1.05;cy=1.05;cz=1.0; % Change cz for different drag in Z axis
...
% PAC computation
   inputpac=[errh1,derrh1,h,i,href];
   h1=0.2*pacgofly(inputpac); % with control scaling factor for altitude
