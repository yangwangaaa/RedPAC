...
cp=5; cq=6; cr=7.0;       %change cr to variate damping
...
% roll angle control -- PID


%-- inputs----
phiref=0*pi/180;  % radians
...
% PAC computation
    inputpac=[errpsi,derrpsi,psi,i,psiref];
        psi1=0.8*pacgoflyyaw(inputpac); %with scaling control input factor
